...
// SPI Stuff
#if CONFIG_LORA_SPI2_HOST
#define HOST_ID SPI2_HOST
#elif CONFIG_LORA_SPI3_HOST
...
void LoRaInit(void)
{
	ESP_LOGI(TAG, "CONFIG_MISO_GPIO=%d", CONFIG_LORA_MISO_GPIO);
	ESP_LOGI(TAG, "CONFIG_MOSI_GPIO=%d", CONFIG_LORA_MOSI_GPIO);
	ESP_LOGI(TAG, "CONFIG_SCLK_GPIO=%d", CONFIG_LORA_SCK_GPIO);
	ESP_LOGI(TAG, "CONFIG_NSS_GPIO=%d", CONFIG_LORA_CS_GPIO);
	ESP_LOGI(TAG, "CONFIG_RST_GPIO=%d", CONFIG_LORA_RST_GPIO);
	...
	SX126x_SPI_SELECT = CONFIG_LORA_CS_GPIO;
	SX126x_RESET = CONFIG_LORA_RST_GPIO;
